...
DEPLOY_DIFFERENCES="${DEPLOY_DIFFERENCES:-NOT SET}" # Set to true to apply pending changes to target. 
...
flywayTargetEnvironment="${TARGET_ENVIRONMENT:-Build}" # Options can be schemaModel, migrations, snapshot, empty, <<environment name>>
